...
namespace AllocateTool.Entity
{
    public partial class Record
    {
        ...
        public string M_asnlink { get; set; }
        ...
        public OleDbParameter[] ToInsertByParamArray()
        {
            OleDbParameter[] param = {
                    ...
                    new OleDbParameter("@M_asnlink",EntityUtils.SqlNull(M_asnlink)),
                    new OleDbParameter("@M_shift",EntityUtils.SqlNull(M_shift)),
        ...
        {
            return String.Format("id:{0},Subject:{1},RequestId:{2},ActionType:{3},mailincomeTime:{4},filePath:{5},", M_id, M_subject, M_requestID, M_actiontype, M_mailincometime);
        }
